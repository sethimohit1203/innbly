    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="absolute left-1/2 -translate-x-1/2 md:left-0 md:translate-x-0 top-full z-[60] mt-2 w-80 rounded-2xl border border-slate-200 bg-white p-4 shadow-card-hover">
