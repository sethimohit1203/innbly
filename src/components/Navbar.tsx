            ...
            {user ? (
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 rounded-full border border-slate-200 py-1 pl-1 pr-3 transition hover:border-slate-300 bg-white shadow-sm active:scale-95"
                >
                  ...
                  <span className="text-xs font-bold text-slate-700">Hi, {user.name.split(' ')[0]}</span>
