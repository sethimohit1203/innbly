...
export const QUICK_FILTERS: QuickFilter[] = [
  ...
  { slug: 'student-pg', label: 'Student PG', predicate: (p) => p.lifestyleTags.includes('Student Living') },
  { slug: 'family-stay', label: 'Family Stay', predicate: (p) => p.lifestyleTags.includes('Family') },
  { slug: 'under-1000', label: 'Under ₹1000', predicate: (p) => p.price < 1000 },
  ...
  { slug: 'women-only', label: 'Women Only', predicate: (p) => p.tenantPreference === 'Girls' },
  ...
  { slug: 'students', label: 'Students', predicate: (p) => p.lifestyleTags.includes('Student Living') },
